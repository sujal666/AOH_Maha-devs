  ...
  return (
    ...
    <Card className={cn("w-[380px] px-8", className)} {...props}>
      <CardHeader>
        ...
        <CardDescription className='text-center'>Free membership includes the following feautred.</CardDescription>
      </CardHeader>
...
Free plan        </Button>
    ...
    <Card className={cn("w-[380px] px-5 ml-40", className)} {...props}>
      <CardHeader>
        ...
        <CardDescription className='text-center'>Premium membership includes the following feautred.</CardDescription>
      </CardHeader>
      <CardContent className="grid gap-4">
      ...
      <CardFooter>
      <Link href={`https://buy.stripe.com/test_3cs5mC3g84y8euA5kk`}>  <Button className="w-full" >
          <Check className="mr-2 h-4 w-4" />Premium Plan
        </Button></Link>
      </CardFooter>
    </Card>
    </div>
